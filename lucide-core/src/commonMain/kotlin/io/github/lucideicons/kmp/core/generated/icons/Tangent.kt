...
private val tangentPath2 = PathParser().parsePathString("M 6 17 A 2 2 0 1 0 2 17 A 2 2 0 1 0 6 17 Z").toNodes()
private val tangentPath3 = PathParser().parsePathString("M12 22s-4-9-1.5-11.5S22 12 22 12").toNodes()

private fun buildTangent(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
