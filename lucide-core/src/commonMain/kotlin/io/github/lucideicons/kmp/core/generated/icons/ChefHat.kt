...
val chefHatProvider = ParameterizedIconProvider { parameters ->
    buildChefHat(parameters)
}
...
private val chefHatPath1 = PathParser().parsePathString("M6 17h12").toNodes()

private fun buildChefHat(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
