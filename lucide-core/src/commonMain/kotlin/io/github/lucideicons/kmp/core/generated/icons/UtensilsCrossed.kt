...
private val utensilsCrossedPath2 = PathParser().parsePathString("m2.1 21.8 6.4-6.3").toNodes()
private val utensilsCrossedPath3 = PathParser().parsePathString("m19 5-7 7").toNodes()

private fun buildUtensilsCrossed(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
