...
private val copyXPath2 = PathParser().parsePathString("M 10 8 H 20 A 2 2 0 0 1 22 10 V 20 A 2 2 0 0 1 20 22 H 10 A 2 2 0 0 1 8 20 V 10 A 2 2 0 0 1 10 8 Z").toNodes()
private val copyXPath3 = PathParser().parsePathString("M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2").toNodes()

private fun buildCopyX(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
