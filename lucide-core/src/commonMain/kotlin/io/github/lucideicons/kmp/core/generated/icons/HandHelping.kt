...
private val handHelpingPath2 = PathParser().parsePathString("m2 13 6 6").toNodes()

private fun buildHandHelping(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
