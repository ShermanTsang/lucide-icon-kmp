...
private val fishingRodPath2 = PathParser().parsePathString("M 20 18 A 2 2 0 1 0 16 18 A 2 2 0 1 0 20 18 Z").toNodes()

private fun buildFishingRod(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
