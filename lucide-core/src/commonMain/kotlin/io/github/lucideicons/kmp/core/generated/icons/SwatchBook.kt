...
private val swatchBookPath2 = PathParser().parsePathString("M 7 17h.01").toNodes()
private val swatchBookPath3 = PathParser().parsePathString("m11 8 2.3-2.3a2.4 2.4 0 0 1 3.404.004L18.6 7.6a2.4 2.4 0 0 1 .026 3.434L9.9 19.8").toNodes()

private fun buildSwatchBook(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
