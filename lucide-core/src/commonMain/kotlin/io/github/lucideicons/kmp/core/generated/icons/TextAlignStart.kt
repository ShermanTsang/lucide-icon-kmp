...
private val textAlignStartPath2 = PathParser().parsePathString("M17 19H3").toNodes()

private fun buildTextAlignStart(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
