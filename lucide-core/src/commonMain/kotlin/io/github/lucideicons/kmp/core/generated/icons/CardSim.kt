...
private val cardSimPath2 = PathParser().parsePathString("M8 14h8").toNodes()
private val cardSimPath3 = PathParser().parsePathString("M 9 10 H 15 A 1 1 0 0 1 16 11 V 17 A 1 1 0 0 1 15 18 H 9 A 1 1 0 0 1 8 17 V 11 A 1 1 0 0 1 9 10 Z").toNodes()

private fun buildCardSim(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
