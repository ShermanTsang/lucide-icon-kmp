...
private val nfcPath2 = PathParser().parsePathString("M12.91 4.1a15.91 15.91 0 0 1 .01 15.8").toNodes()
private val nfcPath3 = PathParser().parsePathString("M16.37 2a20.16 20.16 0 0 1 0 20").toNodes()

private fun buildNfc(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
