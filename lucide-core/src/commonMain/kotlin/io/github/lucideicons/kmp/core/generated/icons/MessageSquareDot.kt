...
val messageSquareDotProvider = ParameterizedIconProvider { parameters ->
    buildMessageSquareDot(parameters)
}
...
private val messageSquareDotPath1 = PathParser().parsePathString("M 22 6 A 3 3 0 1 0 16 6 A 3 3 0 1 0 22 6 Z").toNodes()

private fun buildMessageSquareDot(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = messageSquareDotPath0,
        ...
        addPath(
            pathData = messageSquareDotPath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
