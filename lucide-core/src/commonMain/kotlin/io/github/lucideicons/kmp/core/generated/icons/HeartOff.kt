...
private val heartOffPath2 = PathParser().parsePathString("m2 2 20 20").toNodes()

private fun buildHeartOff(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
