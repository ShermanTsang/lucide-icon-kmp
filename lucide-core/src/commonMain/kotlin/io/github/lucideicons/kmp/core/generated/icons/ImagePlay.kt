...
private val imagePlayPath2 = PathParser().parsePathString("m6 21 5-5").toNodes()
private val imagePlayPath3 = PathParser().parsePathString("M 11 9 A 2 2 0 1 0 7 9 A 2 2 0 1 0 11 9 Z").toNodes()

private fun buildImagePlay(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
