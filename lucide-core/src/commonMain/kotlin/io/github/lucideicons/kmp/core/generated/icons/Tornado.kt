...
private val tornadoPath2 = PathParser().parsePathString("M19 12H9").toNodes()
private val tornadoPath3 = PathParser().parsePathString("M16 16h-6").toNodes()
private val tornadoPath4 = PathParser().parsePathString("M11 20H9").toNodes()

private fun buildTornado(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
