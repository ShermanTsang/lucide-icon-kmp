...
private val mapPinHousePath2 = PathParser().parsePathString("M18 22v-3").toNodes()
private val mapPinHousePath3 = PathParser().parsePathString("M 13 10 A 3 3 0 1 0 7 10 A 3 3 0 1 0 13 10 Z").toNodes()

private fun buildMapPinHouse(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
