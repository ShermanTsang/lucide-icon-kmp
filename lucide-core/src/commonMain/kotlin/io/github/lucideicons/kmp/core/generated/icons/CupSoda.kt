...
private val cupSodaPath2 = PathParser().parsePathString("M7 15a6.47 6.47 0 0 1 5 0 6.47 6.47 0 0 0 5 0").toNodes()
private val cupSodaPath3 = PathParser().parsePathString("m12 8 1-6h2").toNodes()

private fun buildCupSoda(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
