...
private val framePath2 = PathParser().parsePathString("M 6 2 L 6 22").toNodes()
private val framePath3 = PathParser().parsePathString("M 18 2 L 18 22").toNodes()

private fun buildFrame(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
