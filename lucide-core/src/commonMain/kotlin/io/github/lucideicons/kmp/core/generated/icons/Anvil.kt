...
private val anvilPath2 = PathParser().parsePathString("M9 12v5").toNodes()
private val anvilPath3 = PathParser().parsePathString("M15 12v5").toNodes()
private val anvilPath4 = PathParser().parsePathString("M5 20a3 3 0 0 1 3-3h8a3 3 0 0 1 3 3 1 1 0 0 1-1 1H6a1 1 0 0 1-1-1").toNodes()

private fun buildAnvil(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
