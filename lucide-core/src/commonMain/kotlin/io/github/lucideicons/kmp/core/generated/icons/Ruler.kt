...
private val rulerPath2 = PathParser().parsePathString("m11.5 9.5 2-2").toNodes()
private val rulerPath3 = PathParser().parsePathString("m8.5 6.5 2-2").toNodes()
private val rulerPath4 = PathParser().parsePathString("m17.5 15.5 2-2").toNodes()

private fun buildRuler(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
