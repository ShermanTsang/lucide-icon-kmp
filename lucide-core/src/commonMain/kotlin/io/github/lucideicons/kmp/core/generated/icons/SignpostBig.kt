...
private val signpostBigPath2 = PathParser().parsePathString("M10 22V4a2 2 0 1 1 4 0v18").toNodes()
private val signpostBigPath3 = PathParser().parsePathString("M8 22h8").toNodes()

private fun buildSignpostBig(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
