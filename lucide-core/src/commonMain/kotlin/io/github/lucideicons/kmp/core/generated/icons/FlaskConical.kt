...
private val flaskConicalPath2 = PathParser().parsePathString("M8.5 2h7").toNodes()

private fun buildFlaskConical(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
