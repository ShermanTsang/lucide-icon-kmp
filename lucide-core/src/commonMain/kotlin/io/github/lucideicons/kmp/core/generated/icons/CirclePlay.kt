...
val circlePlayProvider = ParameterizedIconProvider { parameters ->
    buildCirclePlay(parameters)
}
...
private val circlePlayPath1 = PathParser().parsePathString("M 22 12 A 10 10 0 1 0 2 12 A 10 10 0 1 0 22 12 Z").toNodes()

private fun buildCirclePlay(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
