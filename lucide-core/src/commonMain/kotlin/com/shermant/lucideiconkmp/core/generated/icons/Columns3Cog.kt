...
private val columns3CogPath2 = PathParser().parsePathString("M15 3v7.5").toNodes()
private val columns3CogPath3 = PathParser().parsePathString("m15.2 16.9-.9-.3").toNodes()
private val columns3CogPath4 = PathParser().parsePathString("m16.6 21.7.3-.9").toNodes()
private val columns3CogPath5 = PathParser().parsePathString("m16.8 15.3-.4-1").toNodes()
private val columns3CogPath6 = PathParser().parsePathString("m19.1 15.2.3-.9").toNodes()
private val columns3CogPath7 = PathParser().parsePathString("m19.6 21.7-.4-1").toNodes()
private val columns3CogPath8 = PathParser().parsePathString("m20.7 16.8 1-.4").toNodes()
private val columns3CogPath9 = PathParser().parsePathString("m21.7 19.4-.9-.3").toNodes()
