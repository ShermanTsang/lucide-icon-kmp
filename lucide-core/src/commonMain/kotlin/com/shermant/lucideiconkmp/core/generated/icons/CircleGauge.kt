...
val LucideIcons.CircleGauge: ImageVector
    get() = circleGaugeProvider.create()
...
private val circleGaugePath2 = PathParser().parsePathString("M13.4 10.6 19 5").toNodes()

private fun buildCircleGauge(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
