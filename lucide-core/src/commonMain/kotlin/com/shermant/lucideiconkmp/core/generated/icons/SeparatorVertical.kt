...
val LucideIcons.SeparatorVertical: ImageVector
    get() = separatorVerticalProvider.create()
...
private val separatorVerticalPath2 = PathParser().parsePathString("m8 8-4 4 4 4").toNodes()

private fun buildSeparatorVertical(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = separatorVerticalPath0,
        ...
        addPath(
            pathData = separatorVerticalPath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = separatorVerticalPath2,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
