...
val LucideIcons.Delete: ImageVector
    get() = deleteProvider.create()
...
private val deletePath2 = PathParser().parsePathString("m18 9-6 6").toNodes()

private fun buildDelete(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
