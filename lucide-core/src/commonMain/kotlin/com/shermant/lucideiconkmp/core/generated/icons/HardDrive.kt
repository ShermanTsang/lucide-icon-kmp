...
val LucideIcons.HardDrive: ImageVector
    get() = hardDriveProvider.create()
...
private val hardDrivePath2 = PathParser().parsePathString("M21.946 12.013H2.054").toNodes()
private val hardDrivePath3 = PathParser().parsePathString("M6 16h.01").toNodes()

private fun buildHardDrive(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
