...
val LucideIcons.MessageSquareCode: ImageVector
    get() = messageSquareCodeProvider.create()
...
private val messageSquareCodePath2 = PathParser().parsePathString("m14 14 3-3-3-3").toNodes()

private fun buildMessageSquareCode(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = messageSquareCodePath0,
        ...
        addPath(
            pathData = messageSquareCodePath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = messageSquareCodePath2,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
