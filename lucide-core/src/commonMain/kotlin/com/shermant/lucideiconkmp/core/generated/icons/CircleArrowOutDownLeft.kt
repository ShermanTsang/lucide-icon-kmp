...
val LucideIcons.CircleArrowOutDownLeft: ImageVector
    get() = circleArrowOutDownLeftProvider.create()
...
private val circleArrowOutDownLeftPath2 = PathParser().parsePathString("M8 22H2v-6").toNodes()

private fun buildCircleArrowOutDownLeft(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = circleArrowOutDownLeftPath0,
        ...
        addPath(
            pathData = circleArrowOutDownLeftPath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = circleArrowOutDownLeftPath2,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
