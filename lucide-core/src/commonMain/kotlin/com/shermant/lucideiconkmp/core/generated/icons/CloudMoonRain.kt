...
val LucideIcons.CloudMoonRain: ImageVector
    get() = cloudMoonRainProvider.create()
...
private val cloudMoonRainPath2 = PathParser().parsePathString("M3 20a5 5 0 1 1 8.9-4H13a3 3 0 0 1 2 5.24").toNodes()
private val cloudMoonRainPath3 = PathParser().parsePathString("M7 19v2").toNodes()

private fun buildCloudMoonRain(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
