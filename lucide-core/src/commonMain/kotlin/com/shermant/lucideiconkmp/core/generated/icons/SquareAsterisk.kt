...
val LucideIcons.SquareAsterisk: ImageVector
    get() = squareAsteriskProvider.create()
...
private val squareAsteriskPath2 = PathParser().parsePathString("m8.5 14 7-4").toNodes()
private val squareAsteriskPath3 = PathParser().parsePathString("m8.5 10 7 4").toNodes()

private fun buildSquareAsterisk(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
