...
val LucideIcons.Spline: ImageVector
    get() = splineProvider.create()
...
private val splinePath2 = PathParser().parsePathString("M5 17A12 12 0 0 1 17 5").toNodes()

private fun buildSpline(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
