...
private val mousePointerBanPath2 = PathParser().parsePathString("m11.8 11.8 8.4 8.4").toNodes()

private fun buildMousePointerBan(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
