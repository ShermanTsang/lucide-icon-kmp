...
val LucideIcons.ArrowBigRightDash: ImageVector
    get() = arrowBigRightDashProvider.create()
...
private fun buildArrowBigRightDash(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = arrowBigRightDashPath0,
        ...
        addPath(
            pathData = arrowBigRightDashPath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
