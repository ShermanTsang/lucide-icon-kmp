...
val LucideIcons.CircleOff: ImageVector
    get() = circleOffProvider.create()
...
private val circleOffPath2 = PathParser().parsePathString("M19.08 19.08A10 10 0 1 1 4.92 4.92").toNodes()

private fun buildCircleOff(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
