...
private val strikethroughPath2 = PathParser().parsePathString("M 4 12 L 20 12").toNodes()

private fun buildStrikethrough(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
