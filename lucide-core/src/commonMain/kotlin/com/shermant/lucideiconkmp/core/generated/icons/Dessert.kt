...
val LucideIcons.Dessert: ImageVector
    get() = dessertProvider.create()
...
private val dessertPath2 = PathParser().parsePathString("M 14 4 A 2 2 0 1 0 10 4 A 2 2 0 1 0 14 4 Z").toNodes()

private fun buildDessert(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
