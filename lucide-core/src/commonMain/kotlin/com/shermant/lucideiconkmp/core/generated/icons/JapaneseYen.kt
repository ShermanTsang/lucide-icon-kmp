...
private val japaneseYenPath2 = PathParser().parsePathString("M6 11h12").toNodes()

private fun buildJapaneseYen(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
