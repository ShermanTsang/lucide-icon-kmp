...
val textCursorProvider = ParameterizedIconProvider { parameters ->
    buildTextCursor(parameters)
}

val TextCursor: ImageVector
    get() = textCursorProvider.create()

val LucideIcons.TextCursor: ImageVector
    get() = textCursorProvider.create()
