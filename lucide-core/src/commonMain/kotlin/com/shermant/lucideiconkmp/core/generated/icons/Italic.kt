...
private val italicPath2 = PathParser().parsePathString("M 15 4 L 9 20").toNodes()

private fun buildItalic(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
