...
val calendarClockProvider = ParameterizedIconProvider { parameters ->
    buildCalendarClock(parameters)
}

val CalendarClock: ImageVector
    get() = calendarClockProvider.create()

val LucideIcons.CalendarClock: ImageVector
    get() = calendarClockProvider.create()
