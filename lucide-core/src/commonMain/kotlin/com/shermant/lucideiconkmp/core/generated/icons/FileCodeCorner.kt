...
val LucideIcons.FileCodeCorner: ImageVector
    get() = fileCodeCornerProvider.create()
...
private val fileCodeCornerPath2 = PathParser().parsePathString("m5 16-3 3 3 3").toNodes()
private val fileCodeCornerPath3 = PathParser().parsePathString("m9 22 3-3-3-3").toNodes()

private fun buildFileCodeCorner(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
