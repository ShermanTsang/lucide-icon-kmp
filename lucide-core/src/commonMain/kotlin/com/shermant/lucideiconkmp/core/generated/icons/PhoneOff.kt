...
val LucideIcons.PhoneOff: ImageVector
    get() = phoneOffProvider.create()
...
private val phoneOffPath2 = PathParser().parsePathString("M4.76 13.582A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 .244.473").toNodes()

private fun buildPhoneOff(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
