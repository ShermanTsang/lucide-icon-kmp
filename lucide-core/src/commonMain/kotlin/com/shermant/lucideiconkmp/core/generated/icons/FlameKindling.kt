...
val LucideIcons.FlameKindling: ImageVector
    get() = flameKindlingProvider.create()
...
private val flameKindlingPath2 = PathParser().parsePathString("m5 18 14 4").toNodes()

private fun buildFlameKindling(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
