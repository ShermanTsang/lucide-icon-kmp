...
val LucideIcons.Vegan: ImageVector
    get() = veganProvider.create()
...
private val veganPath2 = PathParser().parsePathString("M2 2a26.6 26.6 0 0 1 10 20c.9-6.82 1.5-9.5 4-14").toNodes()

private fun buildVegan(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
