...
val squareArrowDownRightProvider = ParameterizedIconProvider { parameters ->
    buildSquareArrowDownRight(parameters)
}

val SquareArrowDownRight: ImageVector
...
private fun buildSquareArrowDownRight(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = squareArrowDownRightPath0,
        ...
        addPath(
            pathData = squareArrowDownRightPath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = squareArrowDownRightPath2,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
