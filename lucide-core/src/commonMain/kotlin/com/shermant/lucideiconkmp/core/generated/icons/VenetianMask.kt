...
private val venetianMaskPath2 = PathParser().parsePathString("M6 11c1.5 0 2.5.5 3 2").toNodes()

private fun buildVenetianMask(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
