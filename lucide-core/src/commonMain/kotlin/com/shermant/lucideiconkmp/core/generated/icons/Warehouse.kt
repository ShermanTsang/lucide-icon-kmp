...
val LucideIcons.Warehouse: ImageVector
    get() = warehouseProvider.create()
...
private val warehousePath2 = PathParser().parsePathString("M6 13h12").toNodes()
private val warehousePath3 = PathParser().parsePathString("M6 17h12").toNodes()

private fun buildWarehouse(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
