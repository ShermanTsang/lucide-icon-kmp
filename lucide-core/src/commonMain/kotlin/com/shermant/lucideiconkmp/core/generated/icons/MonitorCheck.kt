...
val LucideIcons.MonitorCheck: ImageVector
    get() = monitorCheckProvider.create()
...
private val monitorCheckPath2 = PathParser().parsePathString("M12 17v4").toNodes()
private val monitorCheckPath3 = PathParser().parsePathString("M8 21h8").toNodes()

private fun buildMonitorCheck(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
