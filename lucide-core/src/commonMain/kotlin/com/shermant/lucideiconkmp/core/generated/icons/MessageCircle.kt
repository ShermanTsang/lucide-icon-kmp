...
val messageCircleProvider = ParameterizedIconProvider { parameters ->
    buildMessageCircle(parameters)
}
...
private fun buildMessageCircle(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
