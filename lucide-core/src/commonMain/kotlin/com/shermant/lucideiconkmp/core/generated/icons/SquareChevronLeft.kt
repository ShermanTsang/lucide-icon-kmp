...
val LucideIcons.SquareChevronLeft: ImageVector
    get() = squareChevronLeftProvider.create()
...
private fun buildSquareChevronLeft(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = squareChevronLeftPath0,
        ...
        addPath(
            pathData = squareChevronLeftPath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
