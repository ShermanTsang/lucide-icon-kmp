...
val LucideIcons.Clover: ImageVector
    get() = cloverProvider.create()
...
private val cloverPath2 = PathParser().parsePathString("m7.83 7.83 8.34 8.34").toNodes()

private fun buildClover(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
