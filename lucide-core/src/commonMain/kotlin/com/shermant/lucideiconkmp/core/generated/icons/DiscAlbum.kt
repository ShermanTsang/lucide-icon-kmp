...
val LucideIcons.DiscAlbum: ImageVector
    get() = discAlbumProvider.create()
...
private val discAlbumPath2 = PathParser().parsePathString("M12 12h.01").toNodes()

private fun buildDiscAlbum(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
