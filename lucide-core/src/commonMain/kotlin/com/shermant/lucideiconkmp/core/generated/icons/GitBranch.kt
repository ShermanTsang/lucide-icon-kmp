...
val LucideIcons.GitBranch: ImageVector
    get() = gitBranchProvider.create()
...
private val gitBranchPath2 = PathParser().parsePathString("M 9 18 A 3 3 0 1 0 3 18 A 3 3 0 1 0 9 18 Z").toNodes()

private fun buildGitBranch(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
