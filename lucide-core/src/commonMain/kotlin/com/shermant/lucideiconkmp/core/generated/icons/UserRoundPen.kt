...
val LucideIcons.UserRoundPen: ImageVector
    get() = userRoundPenProvider.create()
...
private val userRoundPenPath2 = PathParser().parsePathString("M 15 8 A 5 5 0 1 0 5 8 A 5 5 0 1 0 15 8 Z").toNodes()

private fun buildUserRoundPen(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
