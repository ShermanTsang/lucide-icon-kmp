...
val LucideIcons.Car: ImageVector
    get() = carProvider.create()
...
private val carPath2 = PathParser().parsePathString("M9 17h6").toNodes()
private val carPath3 = PathParser().parsePathString("M 19 17 A 2 2 0 1 0 15 17 A 2 2 0 1 0 19 17 Z").toNodes()

private fun buildCar(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
