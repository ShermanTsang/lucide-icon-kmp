...
private val messageCircleXPath2 = PathParser().parsePathString("m9 9 6 6").toNodes()

private fun buildMessageCircleX(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
