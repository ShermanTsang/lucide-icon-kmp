...
val LucideIcons.PcCase: ImageVector
    get() = pcCaseProvider.create()
...
private val pcCasePath2 = PathParser().parsePathString("M9 6h6").toNodes()
private val pcCasePath3 = PathParser().parsePathString("M9 10h6").toNodes()

private fun buildPcCase(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
