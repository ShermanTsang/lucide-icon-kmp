...
val LucideIcons.MessageSquareLock: ImageVector
    get() = messageSquareLockProvider.create()
...
private val messageSquareLockPath2 = PathParser().parsePathString("M 15 15 H 21 A 1 1 0 0 1 22 16 V 19 A 1 1 0 0 1 21 20 H 15 A 1 1 0 0 1 14 19 V 16 A 1 1 0 0 1 15 15 Z").toNodes()

private fun buildMessageSquareLock(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = messageSquareLockPath0,
        ...
        addPath(
            pathData = messageSquareLockPath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = messageSquareLockPath2,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
