...
val LucideIcons.Merge: ImageVector
    get() = mergeProvider.create()
...
private val mergePath2 = PathParser().parsePathString("m20 22-5-5").toNodes()

private fun buildMerge(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
