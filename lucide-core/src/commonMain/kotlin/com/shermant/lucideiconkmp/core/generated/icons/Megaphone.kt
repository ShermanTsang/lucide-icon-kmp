...
val LucideIcons.Megaphone: ImageVector
    get() = megaphoneProvider.create()
...
private val megaphonePath2 = PathParser().parsePathString("M8 6v8").toNodes()

private fun buildMegaphone(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
