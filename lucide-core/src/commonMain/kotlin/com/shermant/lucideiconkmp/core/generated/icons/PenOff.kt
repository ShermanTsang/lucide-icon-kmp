...
val LucideIcons.PenOff: ImageVector
    get() = penOffProvider.create()
...
private val penOffPath2 = PathParser().parsePathString("m2 2 20 20").toNodes()

private fun buildPenOff(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
