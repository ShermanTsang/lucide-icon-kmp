...
val LucideIcons.ZoomOut: ImageVector
    get() = zoomOutProvider.create()
...
private val zoomOutPath2 = PathParser().parsePathString("M 8 11 L 14 11").toNodes()

private fun buildZoomOut(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
