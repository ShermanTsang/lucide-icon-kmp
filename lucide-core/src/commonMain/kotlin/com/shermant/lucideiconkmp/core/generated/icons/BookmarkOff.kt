...
val LucideIcons.BookmarkOff: ImageVector
    get() = bookmarkOffProvider.create()
...
private val bookmarkOffPath2 = PathParser().parsePathString("M8.656 3H17a2 2 0 0 1 2 2v8.344").toNodes()

private fun buildBookmarkOff(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
