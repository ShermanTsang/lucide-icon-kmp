...
private val lampPath2 = PathParser().parsePathString("M8 20a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1z").toNodes()

private fun buildLamp(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
