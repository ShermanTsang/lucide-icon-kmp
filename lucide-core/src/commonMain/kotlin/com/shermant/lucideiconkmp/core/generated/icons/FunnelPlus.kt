...
val LucideIcons.FunnelPlus: ImageVector
    get() = funnelPlusProvider.create()
...
private val funnelPlusPath2 = PathParser().parsePathString("M19 3v6").toNodes()

private fun buildFunnelPlus(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
