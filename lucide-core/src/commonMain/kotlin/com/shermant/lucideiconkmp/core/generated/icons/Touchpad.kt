...
private val touchpadPath2 = PathParser().parsePathString("M12 20v-6").toNodes()

private fun buildTouchpad(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
