...
val LucideIcons.Frown: ImageVector
    get() = frownProvider.create()
...
private val frownPath2 = PathParser().parsePathString("M 9 9 L 9.01 9").toNodes()
private val frownPath3 = PathParser().parsePathString("M 15 9 L 15.01 9").toNodes()

private fun buildFrown(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
