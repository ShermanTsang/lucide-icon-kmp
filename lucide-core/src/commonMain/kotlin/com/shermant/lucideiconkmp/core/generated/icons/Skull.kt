...
private val skullPath2 = PathParser().parsePathString("M 16 12 A 1 1 0 1 0 14 12 A 1 1 0 1 0 16 12 Z").toNodes()
private val skullPath3 = PathParser().parsePathString("M 10 12 A 1 1 0 1 0 8 12 A 1 1 0 1 0 10 12 Z").toNodes()

private fun buildSkull(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
