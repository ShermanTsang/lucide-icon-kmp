...
val LucideIcons.SearchSlash: ImageVector
    get() = searchSlashProvider.create()
...
private val searchSlashPath2 = PathParser().parsePathString("m21 21-4.3-4.3").toNodes()

private fun buildSearchSlash(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
