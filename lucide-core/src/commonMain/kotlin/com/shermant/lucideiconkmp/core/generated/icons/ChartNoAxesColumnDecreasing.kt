...
val LucideIcons.ChartNoAxesColumnDecreasing: ImageVector
    get() = chartNoAxesColumnDecreasingProvider.create()
...
private val chartNoAxesColumnDecreasingPath2 = PathParser().parsePathString("M19 21v-6").toNodes()

private fun buildChartNoAxesColumnDecreasing(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = chartNoAxesColumnDecreasingPath0,
        ...
        addPath(
            pathData = chartNoAxesColumnDecreasingPath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = chartNoAxesColumnDecreasingPath2,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
