...
val LucideIcons.MapPinCheckInside: ImageVector
    get() = mapPinCheckInsideProvider.create()
...
private fun buildMapPinCheckInside(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = mapPinCheckInsidePath0,
        ...
        addPath(
            pathData = mapPinCheckInsidePath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
