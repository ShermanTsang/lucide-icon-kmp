...
val LucideIcons.BadgeCent: ImageVector
    get() = badgeCentProvider.create()
...
private val badgeCentPath2 = PathParser().parsePathString("M15.4 10a4 4 0 1 0 0 4").toNodes()

private fun buildBadgeCent(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
