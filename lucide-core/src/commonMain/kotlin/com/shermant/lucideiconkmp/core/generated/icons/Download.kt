...
val LucideIcons.Download: ImageVector
    get() = downloadProvider.create()
...
private val downloadPath2 = PathParser().parsePathString("m7 10 5 5 5-5").toNodes()

private fun buildDownload(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
