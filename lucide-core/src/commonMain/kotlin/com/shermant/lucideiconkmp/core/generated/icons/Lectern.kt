...
val LucideIcons.Lectern: ImageVector
    get() = lecternProvider.create()
...
private val lecternPath2 = PathParser().parsePathString("M 9 10 H 15 A 1 1 0 0 1 16 11 V 21 A 1 1 0 0 1 15 22 H 9 A 1 1 0 0 1 8 21 V 11 A 1 1 0 0 1 9 10 Z").toNodes()

private fun buildLectern(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
