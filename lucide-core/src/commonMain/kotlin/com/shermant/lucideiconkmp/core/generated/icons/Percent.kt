...
private val percentPath2 = PathParser().parsePathString("M 20 17.5 A 2.5 2.5 0 1 0 15 17.5 A 2.5 2.5 0 1 0 20 17.5 Z").toNodes()

private fun buildPercent(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
