...
val chartNoAxesCombinedProvider = ParameterizedIconProvider { parameters ->
    buildChartNoAxesCombined(parameters)
}

val ChartNoAxesCombined: ImageVector
    get() = chartNoAxesCombinedProvider.create()

val LucideIcons.ChartNoAxesCombined: ImageVector
    get() = chartNoAxesCombinedProvider.create()
...
private fun buildChartNoAxesCombined(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = chartNoAxesCombinedPath0,
        ...
        addPath(
            pathData = chartNoAxesCombinedPath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = chartNoAxesCombinedPath2,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = chartNoAxesCombinedPath3,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = chartNoAxesCombinedPath4,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = chartNoAxesCombinedPath5,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
