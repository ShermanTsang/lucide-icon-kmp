...
private val webhookPath2 = PathParser().parsePathString("m12 6 3.13 5.73C15.66 12.7 16.9 13 18 13a4 4 0 0 1 0 8").toNodes()

private fun buildWebhook(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
