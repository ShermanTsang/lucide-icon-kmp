...
private val conciergeBellPath2 = PathParser().parsePathString("M12 4v4").toNodes()
private val conciergeBellPath3 = PathParser().parsePathString("M10 4h4").toNodes()

private fun buildConciergeBell(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
