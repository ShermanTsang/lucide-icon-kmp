...
val LucideIcons.SpellCheck: ImageVector
    get() = spellCheckProvider.create()
...
private val spellCheckPath2 = PathParser().parsePathString("m16 20 2 2 4-4").toNodes()

private fun buildSpellCheck(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
