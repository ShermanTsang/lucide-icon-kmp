...
val audioWaveformProvider = ParameterizedIconProvider { parameters ->
    buildAudioWaveform(parameters)
}
...
private fun buildAudioWaveform(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
