...
val LucideIcons.MailPlus: ImageVector
    get() = mailPlusProvider.create()
...
private val mailPlusPath2 = PathParser().parsePathString("M19 16v6").toNodes()
private val mailPlusPath3 = PathParser().parsePathString("M16 19h6").toNodes()

private fun buildMailPlus(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
