...
val LucideIcons.Stone: ImageVector
    get() = stoneProvider.create()
...
private val stonePath2 = PathParser().parsePathString("M14 12 8.47 2.302").toNodes()

private fun buildStone(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
