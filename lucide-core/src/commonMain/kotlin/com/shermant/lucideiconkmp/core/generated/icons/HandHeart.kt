...
val LucideIcons.HandHeart: ImageVector
    get() = handHeartProvider.create()
...
private val handHeartPath2 = PathParser().parsePathString("m2 15 6 6").toNodes()
private val handHeartPath3 = PathParser().parsePathString("m7 20 1.6-1.4c.3-.4.8-.6 1.4-.6h4c1.1 0 2.1-.4 2.8-1.2l4.6-4.4a1 1 0 0 0-2.75-2.91").toNodes()

private fun buildHandHeart(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
