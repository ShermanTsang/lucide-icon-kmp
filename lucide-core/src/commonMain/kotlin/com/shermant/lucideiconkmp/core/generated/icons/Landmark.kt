...
val LucideIcons.Landmark: ImageVector
    get() = landmarkProvider.create()
...
private val landmarkPath5 = PathParser().parsePathString("M6 18v-7").toNodes()

private fun buildLandmark(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
