...
val LucideIcons.Cctv: ImageVector
    get() = cctvProvider.create()
...
private val cctvPath2 = PathParser().parsePathString("M2 19h3.76a2 2 0 0 0 1.8-1.1L9 15").toNodes()
private val cctvPath3 = PathParser().parsePathString("M2 21v-4").toNodes()
private val cctvPath4 = PathParser().parsePathString("M7 9h.01").toNodes()

private fun buildCctv(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
