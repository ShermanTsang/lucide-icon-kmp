...
val LucideIcons.Diff: ImageVector
    get() = diffProvider.create()
...
private val diffPath2 = PathParser().parsePathString("M5 21h14").toNodes()

private fun buildDiff(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
