...
val LucideIcons.MessageSquarePlus: ImageVector
    get() = messageSquarePlusProvider.create()
...
private val messageSquarePlusPath2 = PathParser().parsePathString("M9 11h6").toNodes()

private fun buildMessageSquarePlus(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = messageSquarePlusPath0,
        ...
        addPath(
            pathData = messageSquarePlusPath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = messageSquarePlusPath2,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
