...
private val arrowUpFromLinePath2 = PathParser().parsePathString("M5 21h14").toNodes()

private fun buildArrowUpFromLine(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
