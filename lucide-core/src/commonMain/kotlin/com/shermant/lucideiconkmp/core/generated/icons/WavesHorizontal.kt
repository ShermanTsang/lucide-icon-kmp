...
val LucideIcons.WavesHorizontal: ImageVector
    get() = wavesHorizontalProvider.create()
...
private val wavesHorizontalPath2 = PathParser().parsePathString("M2 5q2.5 2 5 0t5 0 5 0 5 0").toNodes()

private fun buildWavesHorizontal(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
