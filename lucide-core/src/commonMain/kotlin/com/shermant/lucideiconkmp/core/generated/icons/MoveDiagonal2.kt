...
val LucideIcons.MoveDiagonal2: ImageVector
    get() = moveDiagonal2Provider.create()
...
private val moveDiagonal2Path2 = PathParser().parsePathString("m5 5 14 14").toNodes()

private fun buildMoveDiagonal2(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
