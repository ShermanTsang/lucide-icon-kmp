...
val LucideIcons.Sofa: ImageVector
    get() = sofaProvider.create()
...
private val sofaPath2 = PathParser().parsePathString("M4 18v2").toNodes()
private val sofaPath3 = PathParser().parsePathString("M20 18v2").toNodes()
private val sofaPath4 = PathParser().parsePathString("M12 4v9").toNodes()

private fun buildSofa(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
