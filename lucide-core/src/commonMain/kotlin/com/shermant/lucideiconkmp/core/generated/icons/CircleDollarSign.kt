...
val LucideIcons.CircleDollarSign: ImageVector
    get() = circleDollarSignProvider.create()
...
private val circleDollarSignPath2 = PathParser().parsePathString("M12 18V6").toNodes()

private fun buildCircleDollarSign(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = circleDollarSignPath0,
        ...
        addPath(
            pathData = circleDollarSignPath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = circleDollarSignPath2,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
