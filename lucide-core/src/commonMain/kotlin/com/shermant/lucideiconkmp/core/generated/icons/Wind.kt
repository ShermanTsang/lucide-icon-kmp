...
val LucideIcons.Wind: ImageVector
    get() = windProvider.create()
...
private val windPath2 = PathParser().parsePathString("M9.8 4.4A2 2 0 1 1 11 8H2").toNodes()

private fun buildWind(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
