...
val LucideIcons.FileStack: ImageVector
    get() = fileStackProvider.create()
...
private val fileStackPath2 = PathParser().parsePathString("M21 6a2 2 0 0 0-.586-1.414l-2-2A2 2 0 0 0 17 2h-3a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1z").toNodes()

private fun buildFileStack(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
