...
val LucideIcons.Lightbulb: ImageVector
    get() = lightbulbProvider.create()
...
private val lightbulbPath2 = PathParser().parsePathString("M10 22h4").toNodes()

private fun buildLightbulb(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
