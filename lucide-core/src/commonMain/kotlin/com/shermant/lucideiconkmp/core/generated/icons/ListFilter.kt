...
private val listFilterPath2 = PathParser().parsePathString("M9 19h6").toNodes()

private fun buildListFilter(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
