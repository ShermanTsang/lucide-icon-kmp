...
val LucideIcons.Printer: ImageVector
    get() = printerProvider.create()
...
private val printerPath2 = PathParser().parsePathString("M 7 14 H 17 A 1 1 0 0 1 18 15 V 21 A 1 1 0 0 1 17 22 H 7 A 1 1 0 0 1 6 21 V 15 A 1 1 0 0 1 7 14 Z").toNodes()

private fun buildPrinter(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
