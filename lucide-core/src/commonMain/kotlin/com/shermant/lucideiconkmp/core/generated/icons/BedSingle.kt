...
val LucideIcons.BedSingle: ImageVector
    get() = bedSingleProvider.create()
...
private val bedSinglePath2 = PathParser().parsePathString("M3 18h18").toNodes()

private fun buildBedSingle(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
