...
val LucideIcons.CheckLine: ImageVector
    get() = checkLineProvider.create()
...
private val checkLinePath2 = PathParser().parsePathString("M9 15L4 10").toNodes()

private fun buildCheckLine(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
