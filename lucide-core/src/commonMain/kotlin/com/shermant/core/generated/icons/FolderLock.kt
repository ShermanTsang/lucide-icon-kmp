...
private val folderLockPath2 = PathParser().parsePathString("M20 17v-2a2 2 0 1 0-4 0v2").toNodes()

private fun buildFolderLock(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
