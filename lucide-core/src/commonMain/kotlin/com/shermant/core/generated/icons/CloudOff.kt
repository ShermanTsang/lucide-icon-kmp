...
private val cloudOffPath2 = PathParser().parsePathString("m2 2 20 20").toNodes()

private fun buildCloudOff(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
