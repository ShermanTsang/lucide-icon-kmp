...
internal object LucideGeneratedMetadataChunk15 {
    val TentTree = LucideIconMetadata(
        ...
        tags = setOf("camping", "campsite", "holiday", "nomadic", "outdoors", "retreat", "wilderness"),
        zhDisplayName = "帐篷树",
        categories = setOf(LucideIconCategory.Nature, LucideIconCategory.Travel),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    )

    val Tent = LucideIconMetadata(
        key = LucideIconKey("tent"),
        displayName = "Tent",
        tags = setOf("camping", "campsite", "holiday", "indian", "lodge", "native american", "nomadic", "outdoors", "retreat", "teepee", "tipi", "wigwam", "wilderness"),
        zhDisplayName = "帐篷",
        categories = setOf(LucideIconCategory.Nature, LucideIconCategory.Sustainability, LucideIconCategory.Travel),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    )

    val Terminal = LucideIconMetadata(
        key = LucideIconKey("terminal"),
        displayName = "Terminal",
        tags = setOf("code", "command line", "prompt", "shell"),
        zhDisplayName = "终端",
    ...
    val TestTubeDiagonal = LucideIconMetadata(
        key = LucideIconKey("test-tube-diagonal"),
        displayName = "Test Tube Diagonal",
        tags = setOf("ampoule", "ampule", "chemistry", "experiment", "flask", "lab", "phial", "test", "test-tube-2", "tube", "vial"),
        zhDisplayName = "试管对角线",
    ...
    val TestTube = LucideIconMetadata(
        key = LucideIconKey("test-tube"),
        displayName = "Test Tube",
        tags = setOf("ampoule", "ampule", "chemistry", "experiment", "flask", "lab", "phial", "test", "tube", "vial"),
        zhDisplayName = "试管",
        categories = setOf(LucideIconCategory.Science),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    ...
    val TestTubes = LucideIconMetadata(
        key = LucideIconKey("test-tubes"),
        displayName = "Test Tubes",
        tags = setOf("ampoules", "ampules", "chemistry", "experiment", "flasks", "lab", "phials", "test", "tubes", "vials"),
        zhDisplayName = "试管",
        categories = setOf(LucideIconCategory.Science),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    ...
    val TextAlignCenter = LucideIconMetadata(
        key = LucideIconKey("text-align-center"),
        displayName = "Text Align Center",
        tags = setOf("align-center", "alignment", "center", "text"),
        zhDisplayName = "文本居中对齐",
    ...
    val TextAlignEnd = LucideIconMetadata(
        key = LucideIconKey("text-align-end"),
        displayName = "Text Align End",
        tags = setOf("align-right", "alignment", "right", "text"),
        zhDisplayName = "文本对齐结束",
        categories = setOf(LucideIconCategory.Text),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    )
    ...
    val TextAlignJustify = LucideIconMetadata(
        key = LucideIconKey("text-align-justify"),
        displayName = "Text Align Justify",
        tags = setOf("align-justify", "alignment", "justified", "list", "menu", "text"),
        zhDisplayName = "文本对齐对齐",
        categories = setOf(LucideIconCategory.Text),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    )
    ...
    val TextAlignStart = LucideIconMetadata(
        key = LucideIconKey("text-align-start"),
        displayName = "Text Align Start",
        tags = setOf("align-left", "alignment", "left", "list", "text"),
        zhDisplayName = "文本对齐开始",
        categories = setOf(LucideIconCategory.Text),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    )
    ...
    val TextCursorInput = LucideIconMetadata(
        key = LucideIconKey("text-cursor-input"),
        displayName = "Text Cursor Input",
        tags = setOf("select"),
        zhDisplayName = "文本光标输入",
    ...
    val TextInitial = LucideIconMetadata(
        key = LucideIconKey("text-initial"),
        displayName = "Text Initial",
        tags = setOf("drop cap", "font size", "format", "letter", "letter-text", "text", "typography"),
        zhDisplayName = "文本首字母",
        categories = setOf(LucideIconCategory.Text),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    ...
    val TextQuote = LucideIconMetadata(
        key = LucideIconKey("text-quote"),
        displayName = "Text Quote",
        tags = setOf("blockquote", "indent", "quotation", "reply", "response"),
        zhDisplayName = "文字引用",
        categories = setOf(LucideIconCategory.Text),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    ...
    val TextSearch = LucideIconMetadata(
        key = LucideIconKey("text-search"),
        displayName = "Text Search",
        tags = setOf("copy", "data", "document", "find", "lens", "magnifier", "magnifying glass", "pdf", "scan", "txt"),
        zhDisplayName = "文本搜索",
        categories = setOf(LucideIconCategory.Text),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    ...
    val TextWrap = LucideIconMetadata(
        key = LucideIconKey("text-wrap"),
        displayName = "Text Wrap",
        tags = setOf("break", "lines", "paragraph", "words", "wrap-text"),
        zhDisplayName = "文字换行",
    ...
    val Theater = LucideIconMetadata(
        key = LucideIconKey("theater"),
        displayName = "Theater",
        tags = setOf("entertainment", "musical", "podium", "stage", "theater", "theatre"),
        zhDisplayName = "剧院",
        categories = setOf(LucideIconCategory.Buildings, LucideIconCategory.Social),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    )

    val ThermometerSnowflake = LucideIconMetadata(
        key = LucideIconKey("thermometer-snowflake"),
        displayName = "Thermometer Snowflake",
        tags = setOf("celsius", "cold", "fahrenheit", "freeze", "freezing", "temperature", "weather"),
        zhDisplayName = "温度计雪花",
    ...
    val ThermometerSun = LucideIconMetadata(
        key = LucideIconKey("thermometer-sun"),
        displayName = "Thermometer Sun",
        tags = setOf("celsius", "fahrenheit", "hot", "temperature", "warm", "weather"),
        zhDisplayName = "温度计太阳",
        categories = setOf(LucideIconCategory.Weather),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    ...
    val Thermometer = LucideIconMetadata(
        key = LucideIconKey("thermometer"),
        displayName = "Thermometer",
        tags = setOf("celsius", "fahrenheit", "temperature", "weather"),
        zhDisplayName = "温度计",
        categories = setOf(LucideIconCategory.Weather),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    ...
    val ThumbsDown = LucideIconMetadata(
        key = LucideIconKey("thumbs-down"),
        displayName = "Thumbs Down",
        tags = setOf("bad", "dislike", "emotion"),
        zhDisplayName = "拇指朝下",
        categories = setOf(LucideIconCategory.Account, LucideIconCategory.Emoji, LucideIconCategory.Social),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    )

    val ThumbsUp = LucideIconMetadata(
        key = LucideIconKey("thumbs-up"),
        displayName = "Thumbs Up",
        tags = setOf("emotion", "good", "like"),
        zhDisplayName = "竖起大拇指",
        categories = setOf(LucideIconCategory.Account, LucideIconCategory.Emoji, LucideIconCategory.Social),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    ...
    val TicketCheck = LucideIconMetadata(
        key = LucideIconKey("ticket-check"),
        displayName = "Ticket Check",
        tags = setOf("booked", "certified", "checked", "concert", "entry", "event", "pass", "purchased", "receipt", "redeemed", "show", "used", "validated", "verified", "voucher"),
        zhDisplayName = "检票",
    ...
    val TicketMinus = LucideIconMetadata(
        key = LucideIconKey("ticket-minus"),
        displayName = "Ticket Minus",
        tags = setOf("-", "cancel", "concert", "decrease", "entry", "event", "pass", "remove", "show", "subtract", "unbook", "voucher"),
        zhDisplayName = "票减",
        categories = setOf(LucideIconCategory.Transportation),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
    ...
    val TicketPercent = LucideIconMetadata(
        key = LucideIconKey("ticket-percent"),
        displayName = "Ticket Percent",
        tags = setOf("%", "book", "concert", "discount", "entry", "event", "offer", "pass", "purchase", "reduced", "show", "voucher"),
        zhDisplayName = "票价百分比",
    ...
    val TicketPlus = LucideIconMetadata(
        key = LucideIconKey("ticket-plus"),
        displayName = "Ticket Plus",
        tags = setOf("+", "add", "book", "concert", "entry", "event", "pass", "purchase", "show", "voucher"),
        zhDisplayName = "门票加",
        categories = setOf(LucideIconCategory.Transportation),
        defaultStrokeWidth = 2.0f,
        sourceSet = IconSourceSet.BuiltIn,
