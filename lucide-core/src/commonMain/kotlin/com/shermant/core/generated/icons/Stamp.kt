...
private val stampPath2 = PathParser().parsePathString("M5 22h14").toNodes()

private fun buildStamp(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
