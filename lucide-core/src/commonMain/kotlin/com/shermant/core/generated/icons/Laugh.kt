...
private val laughPath2 = PathParser().parsePathString("M 9 9 L 9.01 9").toNodes()
private val laughPath3 = PathParser().parsePathString("M 15 9 L 15.01 9").toNodes()

private fun buildLaugh(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
