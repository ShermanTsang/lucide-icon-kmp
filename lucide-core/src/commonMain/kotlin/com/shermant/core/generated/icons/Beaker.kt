...
private val beakerPath2 = PathParser().parsePathString("M6 14h12").toNodes()

private fun buildBeaker(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
