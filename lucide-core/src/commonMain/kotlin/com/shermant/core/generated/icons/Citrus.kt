...
private val citrusPath2 = PathParser().parsePathString("m14 10-5.5 5.5").toNodes()
private val citrusPath3 = PathParser().parsePathString("M14 17.85V10H6.15").toNodes()

private fun buildCitrus(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
