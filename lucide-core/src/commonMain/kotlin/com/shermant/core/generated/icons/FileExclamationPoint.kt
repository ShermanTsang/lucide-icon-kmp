...
private val fileExclamationPointPath2 = PathParser().parsePathString("M12 17h.01").toNodes()

private fun buildFileExclamationPoint(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = fileExclamationPointPath0,
        ...
        addPath(
            pathData = fileExclamationPointPath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = fileExclamationPointPath2,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
