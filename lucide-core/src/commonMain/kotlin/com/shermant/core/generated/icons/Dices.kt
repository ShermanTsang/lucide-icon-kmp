...
private val dicesPath2 = PathParser().parsePathString("M6 18h.01").toNodes()
private val dicesPath3 = PathParser().parsePathString("M10 14h.01").toNodes()
private val dicesPath4 = PathParser().parsePathString("M15 6h.01").toNodes()
private val dicesPath5 = PathParser().parsePathString("M18 9h.01").toNodes()

private fun buildDices(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
