...
private val piggyBankPath2 = PathParser().parsePathString("M2 8v1a2 2 0 0 0 2 2h1").toNodes()

private fun buildPiggyBank(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
