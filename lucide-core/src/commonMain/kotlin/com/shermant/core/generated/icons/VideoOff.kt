...
private val videoOffPath2 = PathParser().parsePathString("m2 2 20 20").toNodes()

private fun buildVideoOff(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
