...
private val mousePointer2OffPath2 = PathParser().parsePathString("m6.816 11.528-2.779-6.84a.495.495 0 0 1 .651-.651l6.84 2.779").toNodes()

private fun buildMousePointer2Off(parameters: IconRenderParameters = IconRenderParameters()): ImageVector {
    ...
    return ImageVector.Builder(
        ...
        addPath(
            pathData = mousePointer2OffPath0,
        ...
        addPath(
            pathData = mousePointer2OffPath1,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
        ...
        addPath(
            pathData = mousePointer2OffPath2,
            pathFillType = PathFillType.NonZero,
            fill = null,
            stroke = SolidColor(Color.Black),
            strokeLineWidth = strokeWidth,
