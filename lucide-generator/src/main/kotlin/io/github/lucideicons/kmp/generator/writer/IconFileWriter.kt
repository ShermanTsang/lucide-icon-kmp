...
class IconFileWriter {
    ...
    private fun buildFile(icon: ParsedIcon, packageName: String): String {
        ...
        return buildString {
            ...
            appendLine("import io.github.lucideicons.kmp.core.registry.IconRenderParameters")
            appendLine("import io.github.lucideicons.kmp.core.registry.ParameterizedIconProvider")
            appendLine()
