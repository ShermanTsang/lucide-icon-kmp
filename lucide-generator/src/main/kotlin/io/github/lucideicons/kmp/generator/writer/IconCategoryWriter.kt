...
class IconCategoryWriter {
    ...
    private fun buildMainFile(icons: List<ParsedIcon>, chunkCount: Int, packageName: String): String = buildString {
        ...
        appendLine()
        appendLine("import io.github.lucideicons.kmp.core.model.LucideIconMetadata")
        appendLine()
    ...
    private fun buildChunkFile(icons: List<ParsedIcon>, packageName: String, chunkIndex: Int): String = buildString {
        appendLine("package $packageName")
        appendLine()
        appendLine("import io.github.lucideicons.kmp.core.model.IconSourceSet")
        appendLine("import io.github.lucideicons.kmp.core.model.LucideIconCategory")
        appendLine("import io.github.lucideicons.kmp.core.model.LucideIconKey")
        appendLine("import io.github.lucideicons.kmp.core.model.LucideIconMetadata")
        appendLine()
