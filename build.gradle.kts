...
group = providers.gradleProperty("GROUP")
    .orElse("io.github.lucideicons.kmp")
    .get()
...
val publishableLibraryProjects = setOf(
    ":lucide-core",
    ":lucide-compose",
)

val repositoryUrlProvider = providers.gradleProperty("mavenRepositoryUrl")
    .orElse(providers.environmentVariable("MAVEN_REPOSITORY_URL"))
val repositoryUsernameProvider = providers.gradleProperty("mavenUsername")
    .orElse(providers.environmentVariable("MAVEN_USERNAME"))
val repositoryPasswordProvider = providers.gradleProperty("mavenPassword")
...
val pomNameProvider = providers.gradleProperty("POM_NAME")
    .orElse(rootProject.name)
val pomDescriptionProvider = providers.gradleProperty("POM_DESCRIPTION")
    .orElse(rootProject.description.toString())
val pomUrlProvider = providers.gradleProperty("POM_URL")
    .orElse("https://github.com/your-org/${rootProject.name}")
val pomLicenseNameProvider = providers.gradleProperty("POM_LICENSE_NAME")
    .orElse("MIT License")
val pomLicenseUrlProvider = providers.gradleProperty("POM_LICENSE_URL")
    .orElse("https://opensource.org/licenses/MIT")
val pomDeveloperIdProvider = providers.gradleProperty("POM_DEVELOPER_ID")
    .orElse("maintainer")
val pomDeveloperNameProvider = providers.gradleProperty("POM_DEVELOPER_NAME")
    .orElse("Project Maintainer")
val pomDeveloperEmailProvider = providers.gradleProperty("POM_DEVELOPER_EMAIL")
    .orElse("maintainer@example.com")
val pomScmUrlProvider = providers.gradleProperty("POM_SCM_URL")
    .orElse("https://github.com/your-org/${rootProject.name}")
            ...
            pom {
                ...
                developers {
                    developer {
                        ...
                        email.set(pomDeveloperEmailProvider)
                    }
                }
